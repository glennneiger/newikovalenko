...
return array(
  ...
  'tax_amount' => array(
    'name' => __('Transaction Tax Amount', 'memberpress-developer-tools'),
    'type' => 'decimal',
    'default' => '0.00',
    'required' => false,
  ...
  'tax_rate' => array(
    'name' => __('Transaction Tax Rate', 'memberpress-developer-tools'),
    'type' => 'decimal',
    'default' => '0.00',
    'required' => false,
    'desc' => __('Use this to manually set the tax rate for this Transaction', 'memberpress-developer-tools')
  ),
  'tax_desc' => array(
    'name' => __('Transaction Tax Amount', 'memberpress-developer-tools'),
    'type' => 'string',
    'default' => '',
    'required' => false,
    'desc' => __('Use this to manually set the tax description for this Transaction', 'memberpress-developer-tools')
  ),
  'tax_class' => array(
    'name' => __('Transaction Tax Amount', 'memberpress-developer-tools'),
    'type' => 'string',
    'default' => 'standard',
    'required' => false,
    'desc' => __('Use this to manually set the tax class for this Transaction', 'memberpress-developer-tools')
  ),
  'member' => array(
