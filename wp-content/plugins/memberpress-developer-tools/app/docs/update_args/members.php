...
return array(
  ...
  'send_welcome_email' => array(
    ...
    'default' => 'false',
    'required' => false,
    'desc' => __('Works only when creating a new Member and if a transaction has been specified. When set to true this will trigger a welcome email to send to the new member.', 'memberpress-developer-tools')
  ),
