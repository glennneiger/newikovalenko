...
(function( $ ) {
    ...
    _data.optionsMode = {
        ...
        editRegions : {
            ...
            mouseOver: null,
            mouseOut: null,
            tooltips: {mode: 'id', priority: 'global'},
            popovers: {mode: 'off', priority: 'global'}
        },
        editMarkers : {
            responsive: true,
            disableLinks: true,
    ...
    methods = {
        ...
        save : function (){
            ...
            $.post(ajaxurl, {action: 'mapsvg_save', _wpnonce: _data.options._wpnonce, data: data}, function(id){
                if($.isNumeric(id)){
                    ...
                    $.growl.notice({title: "OK", message: msg});
                }else{
                    $.growl.error({message: "An error occured during saving process. Please contact support."});
                }
            }).always(function(){
                ...
                if(onEditMapScreen){
                    ...
                    _data.options.mapsvg_options.afterLoad = function(){
                        ...
                        $('#table-markers').on('click','.mapsvg-marker-id-save',function(e){
                            ...
                            if(checkId.error){
                                $.growl.error({message: checkId.error});
                                return false;
                            }
