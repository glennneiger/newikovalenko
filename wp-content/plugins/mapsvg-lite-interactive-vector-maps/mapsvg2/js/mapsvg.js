...
(function( $ ) {
    ...
    Region.prototype.setFill = function(){
    ...
    var defaults = {
        ...
        colors              : {baseDefault: "#000000", background: "#eeeeee", selected: "#cccccc", hover: "#9d9d9d"},
        regions             : {},
        markers             : [],
        ...
        this.methods = {
            ...
            setColors : function(colors){
                ...
                if(colors.background)
                    _data.$map.css({'background': _data.options.colors.background});
                if(colors.hover)
                    _data.options.colors.hover = colors.hover;
                if(colors.selected)
                    _data.options.colors.selected = colors.selected;
...
//                _data.markerGroups[group].push(marker);
            ...
            showTooltip : function(region){
                ...
                if (tip){
                    _data.mapTip.html(_this.textBr(tip));
                    _data.mapTip.addClass('mapsvg-tooltip-visible');
                }
            },
            getPopoverBody: function(region){
                if(!(_data.options.popovers.mode=='off' && _data.options.popovers.priority =='global'))
            ...
            showPopover : function (e, content, pos){
                ...
                if(content){
                    _data.mapPopover.contentDiv.html(_this.textBr(content));
            ...
            init: function(opts, elem) {
                ...
                _data.t              = function(){return _data.code.length>=((2*10)-15)};
