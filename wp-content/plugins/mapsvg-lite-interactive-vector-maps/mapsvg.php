...
Description: MapSVG turns any SVG file into interactive map or floorplan
...
define('MAPSVG_VERSION', '3.2.3');
define('MAPSVG_JQUERY_VERSION', '8.0.1');
define('MAPSVG_JS_BUILDER_VERSION', '5.0.0');
...
function mapsvg_add_jscss_common(){
    ...
    wp_enqueue_script('handlebars-helpers', MAPSVG_PLUGIN_URL . 'js/handlebars-helpers.js');

    wp_register_script('form.controller.admin.mapsvg', MAPSVG_PLUGIN_URL . 'js/mapsvg-admin/form.mapsvg.js', array('jquery','mapsvg'), '2.0.2');
    ...
    wp_enqueue_script('database-service.admin.mapsvg', MAPSVG_PLUGIN_URL . 'js/mapsvg-admin/database-service.js', array('jquery', 'mapsvg'), null);
    ...
    wp_localize_script('mapsvg','mapsvg_paths',array('root'=>MAPSVG_PLUGIN_URL,'templates'=>MAPSVG_PLUGIN_URL.'js/mapsvg-admin/templates/'));
...
function mapsvg_add_jscss_metabox(){
    ...
    wp_enqueue_script('metaboxadmin.mapsvg.js', MAPSVG_PLUGIN_URL . "js/mapsvg-admin/metaboxadmin.mapsvg.js", array('mapsvg'));
    wp_register_script('form.controller.admin.mapsvg', MAPSVG_PLUGIN_URL . 'js/mapsvg-admin/form.mapsvg.js', array('jquery','mapsvg'), '2.0.2');
    wp_enqueue_script('form.controller.admin.mapsvg');
    ...
    wp_enqueue_style('mapsvg-admin', MAPSVG_PLUGIN_URL . "css/main.css");
...
function mapsvg_add_jscss_admin($hook_suffix){
    ...
    if(isset($_GET['page']) && $_GET['page']=='mapsvg-config'){
        ...
        wp_register_script('admin.mapsvg', MAPSVG_PLUGIN_URL . 'js/admin.js', array('jquery'), MAPSVG_JS_BUILDER_VERSION);
        wp_enqueue_script('admin.mapsvg');

        wp_enqueue_script('controller.admin.mapsvg', MAPSVG_PLUGIN_URL . 'js/mapsvg-admin/controller.js', array('mapsvg','admin.mapsvg'), null);
        wp_enqueue_script('settings.controller.admin.mapsvg', MAPSVG_PLUGIN_URL . 'js/mapsvg-admin/settings-controller.js', array('mapsvg','admin.mapsvg','controller.admin.mapsvg'), null);
        wp_enqueue_script('regions.controller.admin.mapsvg', MAPSVG_PLUGIN_URL . 'js/mapsvg-admin/regions-controller.js', array('mapsvg','admin.mapsvg','controller.admin.mapsvg'), null);
        wp_enqueue_script('regions-list.controller.admin.mapsvg', MAPSVG_PLUGIN_URL . 'js/mapsvg-admin/regions-list-controller.js', array('mapsvg','admin.mapsvg','controller.admin.mapsvg'), null);
        wp_enqueue_script('regions-structure.controller.admin.mapsvg', MAPSVG_PLUGIN_URL . 'js/mapsvg-admin/regions-structure-controller.js', array('mapsvg','admin.mapsvg','controller.admin.mapsvg'), null);
        wp_enqueue_script('directory.controller.admin.mapsvg', MAPSVG_PLUGIN_URL . 'js/mapsvg-admin/directory-controller.js', array('mapsvg','admin.mapsvg','controller.admin.mapsvg'), null);
        wp_enqueue_script('details.controller.admin.mapsvg', MAPSVG_PLUGIN_URL . 'js/mapsvg-admin/details-controller.js', array('mapsvg','admin.mapsvg','controller.admin.mapsvg'), null);
        wp_enqueue_script('filters.controller.admin.mapsvg', MAPSVG_PLUGIN_URL . 'js/mapsvg-admin/filters-controller.js', array('mapsvg','admin.mapsvg','controller.admin.mapsvg'), null);
        wp_enqueue_script('filters-structure.controller.admin.mapsvg', MAPSVG_PLUGIN_URL . 'js/mapsvg-admin/filters-structure-controller.js', array('mapsvg','admin.mapsvg','controller.admin.mapsvg'), null);
        wp_enqueue_script('filters-settings.controller.admin.mapsvg', MAPSVG_PLUGIN_URL . 'js/mapsvg-admin/filters-settings-controller.js', array('mapsvg','admin.mapsvg','controller.admin.mapsvg'), null);
        wp_enqueue_script('actions.controller.admin.mapsvg', MAPSVG_PLUGIN_URL . 'js/mapsvg-admin/actions-controller.js', array('mapsvg','admin.mapsvg','controller.admin.mapsvg'), null);
        wp_enqueue_script('modal.controller.admin.mapsvg', MAPSVG_PLUGIN_URL . 'js/mapsvg-admin/modal-controller.js', array('mapsvg','admin.mapsvg','controller.admin.mapsvg'), null);
        wp_enqueue_script('colors.controller.admin.mapsvg', MAPSVG_PLUGIN_URL . 'js/mapsvg-admin/colors-controller.js', array('mapsvg','admin.mapsvg','controller.admin.mapsvg'), null);
        wp_enqueue_script('javascript.controller.admin.mapsvg', MAPSVG_PLUGIN_URL . 'js/mapsvg-admin/javascript-controller.js', array('mapsvg','admin.mapsvg','controller.admin.mapsvg'), null);
        wp_enqueue_script('templates.controller.admin.mapsvg', MAPSVG_PLUGIN_URL . 'js/mapsvg-admin/templates-controller.js', array('mapsvg','admin.mapsvg','controller.admin.mapsvg'), null);
        wp_enqueue_script('database.controller.admin.mapsvg', MAPSVG_PLUGIN_URL . 'js/mapsvg-admin/database-controller.js', array('mapsvg','admin.mapsvg','controller.admin.mapsvg'), null);
        wp_enqueue_script('database-list.controller.admin.mapsvg', MAPSVG_PLUGIN_URL . 'js/mapsvg-admin/database-list-controller.js', array('mapsvg','admin.mapsvg','controller.admin.mapsvg'), '2.0.0');
        wp_enqueue_script('database-structure.controller.admin.mapsvg', MAPSVG_PLUGIN_URL . 'js/mapsvg-admin/database-structure-controller.js', array('mapsvg','admin.mapsvg','controller.admin.mapsvg'), null);
        wp_enqueue_script('database-settings.controller.admin.mapsvg', MAPSVG_PLUGIN_URL . 'js/mapsvg-admin/database-settings-controller.js', array('mapsvg','admin.mapsvg','controller.admin.mapsvg'), null);
        wp_enqueue_script('css.controller.admin.mapsvg', MAPSVG_PLUGIN_URL . 'js/mapsvg-admin/css-controller.js', array('mapsvg','admin.mapsvg','controller.admin.mapsvg'), null);

        wp_register_script('form.controller.admin.mapsvg', MAPSVG_PLUGIN_URL . 'js/mapsvg-admin/form.mapsvg.js', array('jquery','mapsvg','admin.mapsvg'), '2.0.2');
        wp_enqueue_script('form.controller.admin.mapsvg');
...
//    	wp_enqueue_style('jquery.message.css');
        ...
        wp_register_script('codemirror.css', MAPSVG_PLUGIN_URL . 'js/codemirror.css.js', null, '1.0');
        ...
        wp_register_script('codemirror.hint', MAPSVG_PLUGIN_URL . 'js/codemirror.show-hint.js', null, '1.0');
        wp_enqueue_script('codemirror.hint');
        wp_register_script('codemirror.anyword-hint', MAPSVG_PLUGIN_URL . 'js/codemirror.anyword-hint.js', null, '1.0');
        wp_enqueue_script('codemirror.anyword-hint');
        wp_register_style('codemirror.hint.css', MAPSVG_PLUGIN_URL . 'css/codemirror.show-hint.css', null, '1.0');
...
function mapsvg_print( $atts ){
    ...
    $data  = '<div id="mapsvg-'.$post->ID.'" class="mapsvg"><div class="mapsvg-copyright">Powered by <a href="http://mapsvg.com/?utm_source=mapsvg_lite&utm_medium=copyright-link&utm-campaign=MapSVG-Lite">MapSVG</a></div></div>';
...
//    check_ajax_referer('ajax_mapsvg_save-'.$_POST['data']['map_id']);
    ...
    if(isset($data['map_id']) && $data['map_id']!='new'){
        ...
        if(isset($data['region_prefix'])){
            $old_prefix = get_post_meta($post_id, 'mapsvg_region_prefix', true);
            if(!$old_prefix)
                $old_prefix = '';
            if($old_prefix != $data['region_prefix'])
...
function mapsvg_get_schema($map_id, $table){
    ...
    return $wpdb->get_var("SELECT fields FROM ".$wpdb->prefix."mapsvg_schema WHERE table_name='".esc_sql($table_name)."'");
}
...
//    global $wpdb;
//    $wpdb->query(stripslashes($_POST['query']));
//}
...
function mapsvg_copy($id, $new_title){
    ...
    if($mapsvg_table_db){
        ...
        $r2d = $wpdb->get_row("SELECT * FROM ".$wpdb->prefix."mapsvg_r2d", OBJECT);
        if(isset($r2d->map_id)){
            $r2d->map_id = $new_id;
            $wpdb->insert($wpdb->prefix."mapsvg_r2d", $r2d);
        }
    }
        ...
        if(!isset($mapsvg_error)){
            ...
            if(strtolower($file_parts['extension'])!='svg'){
                ...
                if (@move_uploaded_file($_FILES["svg_file"]["tmp_name"], $target_file)) {
                    ...
                    $mapsvg_notice = 'The file <b>'.$filename.'</b> has been uploaded.';
...
//            wp_redirect(admin_url('?page=mapsvg-config&file_uploaded=1'));
        }

    }

    // If $_GET['map_id'] is set then we should get map's settings from DB
    $map_id = isset($_GET['map_id']) ? $_GET['map_id'] : null;

    // If it's new map - create it in the DB and reload the page
    if($map_id == 'new'){

        $data = array('map_id'=>'new','mapsvg_data'=>'{source: "'.$svg_file_url.'"}');
        $id = mapsvg_save($data);
        ...
        mapsvg_set_regions_table($id, $svg_file_url, $prefix);
...
function mapsvg_set_regions_table($map_id, $svg_file_url, $prefix){
    ...
    $map_svg    = simplexml_load_file('http'.($ssl ? 's' : '').'://'.$_SERVER['HTTP_HOST'].$port.$svg_file_url);
    ...
    while($obj = next($allowed_objects)){
        ...
        if(!empty($nodes)){
                ...
                if(isset($o['id']) && ! empty($o['id'])){
                    if($o['id']){
                        ...
                        if(!$prefix || ($prefix && strpos($o['id'],$prefix)===0)){
                            $rid       = ltrim((string)$o['id'], $prefix);
                            $title     = isset($o['title']) && ! empty($o['title']) ? (string)$o['title'] : '';
                            $regions[] = "('".esc_sql($rid) ."','".esc_sql($title)."')";
                        }
                    }
                }
            }
            ...
            // Clear regions table
            $wpdb->query('TRUNCATE '.mapsvg_table_name($map_id, 'regions'));
            
            if(!empty($regions)){
                $wpdb->query('INSERT INTO '.mapsvg_table_name($map_id, 'regions').' (id, region_title) VALUES '.implode(',',$regions));
            }
...
//                echo 'SELECT id, region_title as title FROM '.mapsvg_table_name($map_id, 'regions').' WHERE id IN (\''.implode('\',\'', $data[$key]).'\')';
                $_data[$key] = json_encode($data[$key]);
                break;
            case 'status':
                $key_text = $key.'_text';
                $_data[$key] = $value;
...
function mapsvg_data_update($data){
    global $wpdb;

    $data  = stripslashes_deep($_POST['data']); //array_intersect_key($_POST['data'], array('map_id','region_id','marker_id','lat','lon','post_id','params'));
    $table = $_POST['table'];

    $data_id = $wpdb->get_var("SELECT id FROM ".mapsvg_table_name($_POST['map_id'], $table)." WHERE id='".esc_sql($_POST['id'])."'");


    if($data_id)
        $wpdb->update(mapsvg_table_name($_POST['map_id'], $table), mapsvg_encode_data($_POST['map_id'], $table, $data), array('id'=>esc_sql($_POST['id'])));
    else
        $wpdb->insert(mapsvg_table_name($_POST['map_id'], $table), mapsvg_encode_data($_POST['map_id'], $table, $data));

    if($data_id && isset($data['regions']) && is_array($data['regions'])){
        $regions = $data['regions'];
...
function mapsvg_data_delete($id){
    global $wpdb;
    $table = $_POST['table'];
    $wpdb->delete(mapsvg_table_name((int)$_POST['map_id'], $table), array('id'=>$_POST['id']));
    $wpdb->delete($wpdb->prefix.'mapsvg_r2d', array('map_id'=>$_POST['map_id'], 'object_id'=>(int)$_POST['id']));
    die();
}
...
function mapsvg_data_get_all(){
    ...
    $_fields = $wpdb->get_results('DESCRIBE '.mapsvg_table_name($map_id, $table));
    $fields = array();
    if($_fields){
        ...
        if($searchable_fields){
            if(isset($search_fallback) && $search_fallback){
                ...
                foreach($searchable_fields as $f){
                    if($f == 'regions')
                        $like_fields[] = '`'.$f.'` LIKE \'%"'.esc_sql($search).'%\'';
                    else
                        $like_fields[] = '`'.$f.'` LIKE \''.esc_sql($search).'%\'';
                }
                ...
                foreach($searchable_fields as $index=>$f){
                    if($f == 'regions'){
                        $_search[] = '`'.$f.'` LIKE \'%"'.esc_sql($search).'%\'';
                        array_splice($searchable_fields, $index, 1);
                    }
                }
                if(count($searchable_fields))
                    $_search[] = 'MATCH ('.implode(',',$searchable_fields).') AGAINST (\''.esc_sql($search).'*\' IN BOOLEAN MODE)';
...
//    die();
    ...
    if(isset($_GET['sortBy']) && !empty($_GET['sortBy'])){
        $_sortBy = $table == 'regions' && $_GET['sortBy'] == 'title' ? 'region_title' : $_GET['sortBy'];
...
function mapsvg_set_db($map_id, $table, $schema, $prev_schema) {
    ...
    foreach($schema as $field){
        ...
        if($field['type'] == 'select' || $field['type'] == 'radio' || $field['type'] == 'status'){
    ...
    if(!empty($prev_schema)) foreach($prev_schema as $_field){
        ...
        if(isset($_field['options']) && $_field['type']!='marker'&&$_field['type']!='region'){
            ...
            if($diff){
                $update_options[$_field['name']] = $diff;
            }
        }
...
".$primary_key.$searchable_fields."
    ...
    if($update_options){
        foreach($update_options as $field_name => $options_list){
...
function mapsvg_add_jscss_admin_2(){
    ...
    if(isset($_GET['page']) && $_GET['page']=='mapsvg-config'){
        ...
        wp_register_script('admin.mapsvg', MAPSVG_PLUGIN_URL . 'mapsvg2/js/admin.js', array('jquery'), MAPSVG_JS_BUILDER_VERSION);
        wp_enqueue_script('admin.mapsvg');
